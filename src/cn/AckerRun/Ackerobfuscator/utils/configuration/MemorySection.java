...
public class MemorySection implements ConfigurationSection
{
    ...
    protected MemorySection(final ConfigurationSection parent, final String path) {
        ...
        this.path = path;
        this.parent = parent;
        Validate.notNull(this.root = parent.getRoot(), "Path cannot be orphaned", new Object[0]);
    ...
    public void set(final String path, final Object value) {
        ...
        while ((i1 = path.indexOf(separator, i2 = i1 + 1)) != -1) {
            final String key = path.substring(i2, i1);
            final ConfigurationSection subSection = ((ConfigurationSection)section).getConfigurationSection(key);
            if (subSection == null) {
